...
public class LocalChunkTest {
  ...
  //    ((LocalChunk) chunk).setIndexer(new IndexerMock(chunk));
  ...
  //      Assert.assertEquals("world" + (i / 2),
  // batchRecord.getRecords(0).getValue().toStringUtf8());
  //      Assert.assertEquals(
  ...
  //    private Chunk chunk;
  //
  //    public IndexerMock(Chunk chunk) {
  //      super("");
  //      this.chunk = chunk;
  //    }
  //
